							...
							<tr>
								...
								<td>
									<form action="{{ url('doctor/service', $value['id_doctor_service']) }}" method="POST">
										...
										@csrf
										@method('DELETE')
										<button type="submit" class="btn btn-sm red delete" data-toggle="confirmation" data-popout="true" data-id="{{ $value['id_doctor_service'] }}"><i class="fa fa-trash-o"></i></button>
										@endif
									</form>
								</td>
							</tr>
