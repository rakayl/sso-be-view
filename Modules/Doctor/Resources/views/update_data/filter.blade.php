                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                                    <option value="doctor_name" @if ($con['subject'] == 'doctor_name') selected @endif>Name</option>
                                                    <option value="doctor_phone" @if ($con['subject'] == 'doctor_phone') selected @endif>Phone</option>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                                    ...
                                                    <option value="doctor_phone">Phone</option>
