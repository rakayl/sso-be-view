...
@section('content')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" action="{{url('plastic-type/position')}}" method="post" enctype="multipart/form-data">
                <div class="form-body">
                    @if(!empty($data))
                        <div class="row">
                            <div class="col-md-4">
                                <div class="dd" id="nestable3">
                                    <ol class='dd-list dd3-list'>
                                        @foreach($data as $value)
                                            <li class='dd-item'>
                                                <div class='dd-handle'><i class="sort-icon fa fa-arrows"></i> {{$value['plastic_type_name']}}</div>
                                                <input type="hidden" name="id_plastic_type[]" value="{{$value['id_plastic_type']}}">
                                            </li>
                                        @endforeach
                                    </ol>
                                </div>
