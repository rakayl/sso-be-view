...
@section('page-script')
	...
	$(document).ready(function() {
		...
		$('#tableUsers').DataTable( {
            ...
            pageLength: 10,
            dom: "<'row' <'col-md-12'>><'row'<'col-md-6 col-sm-12'l><'col-md-6 col-sm-12'f>r><'table-scrollable't><'row'<'col-md-12 text-center col-sm-12'i><'col-md-12 text-center col-sm-12'p>>",
		    orderMulti: false,
            buttons: [ {
              extend: "copy",
