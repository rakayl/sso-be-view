<script>
    ...
    function changeSubject(val){
        ...
        if(subject_value == 'outlet_total_rating'){
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                                    ...
                                                    <option value="outlet_total_rating" @if ($con['subject'] == 'outlet_total_rating') selected @endif>Rating</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <select name="operator" class="form-control input-sm select2" placeholder="Search Operator" id="test" style="width:100%">
                                                    @if($con['subject'] == 'outlet_total_rating')
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                                    ...
                                                    <option value="outlet_total_rating">Rating</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <select name="operator" class="form-control input-sm select2" placeholder="Search Operator" id="test" style="width:100%">
