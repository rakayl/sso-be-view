...
@section('content')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            <form class="form-horizontal form-bordered" action="{{ url('setting/faq/kontraktor/update', $faq['id_faq_kontraktor']) }}" method="post">
                <div class="form-body">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a type="button" class="btn default" href="{{url('setting/faq')}}">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
