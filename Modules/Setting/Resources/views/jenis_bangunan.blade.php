...
<div class="portlet card_ light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-blue bold uppercase">Jenis Bangunan Setting</span>
            </div>
        </div>
                    ...
                    <div class="tab-pane fade active in" id="tab_Android">
                        <form class="form-horizontal" role="form" action="{{ url()->current() }}" method="post" enctype="multipart/form-data">
                            <div class="portlet light">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="name[][value]" required placeholder="Jenis Bangunan">
                                                            <span class="input-group-addon">
                                                                <i style="color:#333" class="fa fa-question-circle tooltips" data-original-title="Jenis Bangunan" data-container="body"></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <i class="fa fa-plus"></i> Add New Jenis Bangunan</a>
                            </div>
                            ...
                            '<div class="mt-repeater-item mt-overflow">'+
                                '<div class="mt-repeater-cell">'+
                                    '<div class="col-md-12">'+
                                        ...
                                        '<div class="col-md-5">'+
                                            '<div class="input-group">'+
                                                '<input type="text" class="form-control" name="name[][value]" value="'+version+'" required placeholder="Jenis Bangunan">'+
                                                '<span class="input-group-addon">'+
                                                    '<i style="color:#333" class="fa fa-question-circle tooltips" data-original-title="Jenis Bangunan" data-container="body"></i>'+
                                                '</span>'+
                                            '</div>'+
                            ...
                            '<div class="mt-repeater-item mt-overflow">'+
                                '<div class="mt-repeater-cell">'+
                                    '<div class="col-md-12">'+
                                        ...
                                        '<div class="col-md-5">'+
                                            '<div class="input-group">'+
                                                '<input type="text" class="form-control" name="name[][value]" value="" required placeholder="Jenis Bangunan">'+
                                                '<span class="input-group-addon">'+
                                                    '<i style="color:#333" class="fa fa-question-circle tooltips" data-original-title="Jenis Bangunan" data-container="body"></i>'+
                                                '</span>'+
                                            '</div>'+
