<script>
	...
	function changeSubject(val){
		...
		if(subject_value == 'autoresponse_transaction_type'){
			var operator = "conditions["+index+"][operator]";
			var operator_value = document.getElementsByName(operator)[0];
			for(i = operator_value.options.length - 1 ; i >= 0 ; i--) operator_value.remove(i);
			operator_value.options[operator_value.options.length] = new Option('All', 'All');
		...
		}else if(subject_value == 'autoresponse_payment_method'){
			var operator = "conditions["+index+"][operator]";
			var operator_value = document.getElementsByName(operator)[0];
			for(i = operator_value.options.length - 1 ; i >= 0 ; i--) operator_value.remove(i);
			operator_value.options[operator_value.options.length] = new Option('All', 'All');
										...
										<div class="col-md-12">
											...
											<div class="col-md-4">
												<select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
													<option value="autoresponse_code_name" @if ($con['subject'] == 'autoresponse_code_name') selected @endif>Name</option>
													<option value="autoresponse_transaction_type" @if ($con['subject'] == 'autoresponse_transaction_type') selected @endif>Transaction Type</option>
													<option value="autoresponse_payment_method" @if ($con['subject'] == 'autoresponse_payment_method') selected @endif>Payment Method</option>
												</select>
											</div>
											<div class="col-md-4">
												<select name="operator" class="form-control input-sm select2" placeholder="Search Operator" id="test" style="width:100%">
													@if($con['subject'] == 'autoresponse_transaction_type')
														<option value="All" @if($con['operator'] == 'All') selected @endif>All</option>
														<option value="Pickup Order" @if($con['operator'] == 'Pickup Order') selected @endif>Pickup Order</option>
														<option value="Delivery" @if($con['operator'] == 'Delivery') selected @endif>Delivery</option>
													@elseif($con['subject'] == 'autoresponse_payment_method')
														@foreach($payment_list as $val)
															<option value="{{$val['payment_method']}}" @if($con['operator'] == $val['payment_method']) selected @endif>{{$val['payment_method']}}</option>
														@endforeach
													@else
											...
											<div class="col-md-3">
												@if($con['subject'] == 'autoresponse_transaction_type' || $con['subject'] == 'autoresponse_payment_method')
										...
										<div class="col-md-12">
											...
											<div class="col-md-4">
												<select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
													...
													<option value="autoresponse_code_name">Name</option>
													<option value="autoresponse_transaction_type">Transaction Type</option>
													<option value="autoresponse_payment_method">Payment Method</option>
												</select>
											</div>
											<div class="col-md-4">
												<select name="operator" class="form-control input-sm select2" placeholder="Search Operator" id="test" style="width:100%">
