	...
	<form class="form-horizontal" id="form_interview" role="form" action="{{url('transaction/detail/step')}}" method="post" enctype="multipart/form-data">
		<div class="form-body">
			<div style="text-align: center"><h3>Pengerjaan sedot wc</h3></div>
				...
				<div class="col-md-6">
                                    <select @if($detail['transaction_status_code']==4&&$detail['step_number']!=3) disabled @endif name="id_accommodation" class="form-control input-sm select2" placeholder="Search vendor" data-placeholder="Choose Armada" required>
