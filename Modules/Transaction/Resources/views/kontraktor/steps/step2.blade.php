	...
	<form class="form-horizontal" id="form_interview" role="form" action="{{url('transaction/detail/kontraktor/step')}}" method="post" enctype="multipart/form-data">
		<div class="form-body">
			...
			<div class="form-group">
				...
				<div class="col-md-6 ">
                                    <input  @if($detail['transaction_status_code']==4&&$detail['step_number']!=1) disabled @endif class="form-control" value="{{$detail['step']['step2']['procesed_by']}}" >
                                </div>
			</div>
                        <div class="form-group">
