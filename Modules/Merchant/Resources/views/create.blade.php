            ...
            <form class="form-horizontal" role="form" action="{{ url('tukang-sedot/store') }}" method="post" enctype="multipart/form-data">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="merchant_name" required placeholder="Vendor Name">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-icon right">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control onlynumber" name="merchant_license_number" required placeholder="Vendor License Number">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <textarea name="merchant_address" class="form-control" placeholder="Vendor Address" required></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">
