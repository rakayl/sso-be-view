                ...
                <form class="form-horizontal" role="form" action="{{url('tarif/tarif/update')}}" method="post" enctype="multipart/form-data">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="name_tarif" value="{{$tarif['name_tarif']}}" placeholder="Masukkan nama tarif" class="form-control" required />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="price_tarif" value="{{$tarif['price_tarif']}}" data-type="currency" placeholder="Masukkan besar value" class="form-control" required />
                                    </div>
                                </div>
