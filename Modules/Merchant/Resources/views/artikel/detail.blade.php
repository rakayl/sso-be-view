...
@section('content')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" action="{{ url('artikel/update/'.$result['id_artikel']) }}" method="post" enctype="multipart/form-data">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="title" required placeholder="Title" value="{{$result['title']}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-icon right">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="category" required placeholder="Category" value="{{$result['category']}}">
                        </div>
                    </div>
                        ...
                        <div class="fileinput fileinput-new col-md-8" data-provides="fileinput">
                                <div class="fileinput-preview fileinput-new thumbnail">
                                    @if(isset($result['image']))
                                                <img src="{{$result['image']}}" style="max-width: 250px; max-height: 250px;" alt="">
                                        @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control summernote" id="id_text" name="content">{!! $result['content'] !!}</textarea>
                        </div>
                    </div>
                </div>
