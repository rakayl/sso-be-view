...
@section('content')
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-blue sbold uppercase">New Accommodation</span>
            </div>
        </div>
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" action="{{ url('accommodation/store') }}" method="post" enctype="multipart/form-data">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <div class="input-icon right">
                            <label class="col-md-3 control-label">
                                ...
                                <i class="fa fa-question-circle tooltips" data-original-title="Vendor Tukang Sedot" data-container="body"></i>
                            </label>
                        </div>
                        <div class="col-md-8">
                            <select id="province" name="id_outlet" class="form-control select2-multiple" data-placeholder="Select Tukang Sedot" required>
                                <option></option>
                                @if (!empty($outlet))
                                    @foreach($outlet as $suw)
                                        <option value="{{ $suw['id_outlet'] }}">{{ $suw['outlet_name'] }} - ({{$suw['outlet_code']}})</option>
                                    @endforeach
                                @endif
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="number_accommodation" class="form-control"  style="text-transform:uppercase"  placeholder="Plat Nomor" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-icon right">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="merk" class="form-control"placeholder="Merk Accommodation" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-icon right">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="type" class="form-control" placeholder="Type Accommodation" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-icon right">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="number" name="capacity" class="form-control" placeholder="Capacity Accommodation" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="fileinput fileinput-new col-md-8" data-provides="fileinput">
                                ...
                                <div>
                                        ...
                                        <input type="file" class="file-splash" id="field_splash" accept="image/*" name="attachment" required>
                                        </span>
