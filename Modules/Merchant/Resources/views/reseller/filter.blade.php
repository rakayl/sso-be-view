                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                        <option value="users.name" @if ($con['subject'] == 'users.name') selected @endif>Name</option>
                                        <option value="outlets.name" @if ($con['subject'] == 'outlets.name') selected @endif>Outlet</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                       <option value="users.name">Name</option>
                                        <option value="outlets.name">Outlet</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <select name="operator" class="form-control input-sm select2" placeholder="Search Operator" id="test" style="width:100%">
