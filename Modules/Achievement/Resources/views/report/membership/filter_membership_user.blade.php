...
<div class="portlet light bordered">
    ...
    <div class="portlet-body form">
        <div class="form-body">
            <form role="form" class="form-horizontal" id="filter-user" action="{{url()->current()}}?filter=1" method="POST">
                {{ csrf_field() }}
            ...
            <div style="margin-left: 1.5%">
                <button onclick="datatables('filter')" class="btn yellow"><i class="fa fa-search"></i> Search</button>
