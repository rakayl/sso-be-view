                            ...
                            <div class="form-body">
                                ...
                                @if(MyHelper::hasAccess([39], $configs))
                                    ...
                                    <div class="form-group" id="div_sms_content_check_promo_code" style="display:none">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="sms_content" id="sms_content_check_promo_code" class="form-control field_sms_check_promo_code" placeholder="SMS Content" maxlength="135">@if(!empty(old('sms_content'))) {{old('sms_content')}} @else @if(isset($result[5]['sms_content']) && $result[5]['sms_content'] != '') {{$result[5]['sms_content']}} @endif @endif</textarea>
                                            <br>
                                            You can use this variables to display user personalized information:
                                            <br><br>
                                            <div class="row">
