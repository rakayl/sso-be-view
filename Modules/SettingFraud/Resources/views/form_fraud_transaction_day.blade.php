                            ...
                            <div class="form-body">
                                ...
                                @if(MyHelper::hasAccess([39], $configs))
                                    ...
                                    <div class="form-group" id="div_sms_content_transaction_in_day" style="display:none">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="sms_content" id="sms_content_transaction_in_day" class="form-control field_sms_transaction_in_day" placeholder="SMS Content" maxlength="135">@if(!empty(old('sms_content'))) {{old('sms_content')}} @else @if(isset($result[0]['sms_content']) && $result[0]['sms_content'] != '') {{$result[0]['sms_content']}} @endif @endif</textarea>
                                            <br>
                                            You can use this variables to display user personalized information:
                                            <br><br>
                                            <div class="row">
